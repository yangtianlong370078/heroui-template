...
export default function SidebarFloatingVariantDemo() {
  return (
    <div className="h-[500px] w-full overflow-hidden rounded-xl border">
      <Sidebar.Provider variant="floating" toggleShortcut={false}>
        <Sidebar>
          <Sidebar.Header>
        ...
        <Sidebar.Main>
          <div className="p-6">
            <h2 className="text-xl font-bold">Floating Variant</h2>
            <p className="mt-2 text-sm text-foreground/60">
              The <code>variant="floating"</code> renders the sidebar with rounded corners and a
              shadow, detached from the viewport edge.
            </p>
          </div>
        </Sidebar.Main>
      </Sidebar.Provider>
