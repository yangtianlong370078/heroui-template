...
export default function SidebarInsetVariantDemo() {
  return (
    <div className="h-[500px] w-full overflow-hidden rounded-xl border">
      <Sidebar.Provider variant="inset" toggleShortcut={false}>
        <Sidebar>
          <Sidebar.Header>
        ...
        <Sidebar.Main>
          <div className="p-6">
            <h2 className="text-xl font-bold">Inset Variant</h2>
            <p className="mt-2 text-sm text-foreground/60">
              The <code>variant="inset"</code> uses a transparent sidebar background with a
